    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="wrap">
                ...
                <input class="form-control" input type="text" name="account" placeholder="帳號" required />
                <input class="form-control" input type="password" name="password" placeholder="密碼" required />
